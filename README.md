# Enhanced Framework - Combat - Enhanced Engine, Part V
...
The "Enhanced Framework - Combat" features an advanced system for objects that can take damage and inflict them, with multiple interlinked sub-systems. <br/>
...
```txt
https://github.com/TetsuoYoshima/EnhancedFramework-Combat.git
```
